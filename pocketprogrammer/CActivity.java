 ...
 *
 * Loads when 'C' button is clicked in Systems activity.
 */

public class CActivity extends AppCompatActivity {

    private ListView mCList;
    private WebView mCWebView = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCList = (ListView) findViewById(R.id.C_list);
        mCList.setAdapter(adapter);

        mCList.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                switch (position)
                {
                    ...
                    case 0:
                        ...
                        intent.putExtra("search", "c structs");
